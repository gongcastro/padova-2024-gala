...
* But some animals show certain ability to process some aspects of language [e.g., @christiansen2003language; @fitch2018biology; @santolin2018constraints; @petkov2020structured; @toro2016something]
...
## Proposed block design (feed-back!)
...
## Study 2: testing the sensory basis of the SSP in non-linguistic inputs
...
1. Test phase:
  - 4 blocks of strings of tones (20-22s silence between blocks):
      + 2 non-alternating ([SSP+]{style="background-color: #ea6212; color: white"} *or* [SSP-]{style="background-color: #781478; color: white"})
      + 2 Alt ([SSP+]{style="background-color: #ea6212; color: white"} *and* [SSP-]{style="background-color: #781478; color: white"})
  - 12 strings of pure tones different words in each block (0.5-1.5s silence between words)
